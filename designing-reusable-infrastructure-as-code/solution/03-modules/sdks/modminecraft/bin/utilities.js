    ...
    return __awaiter(this, void 0, void 0, function* () {
        if (_packageRef === undefined) {
            ...
            if (_packageRef === undefined) {
                ...
                params.setName("modminecraft");
                params.setVersion("0.0.1");
                params.setValue(Uint8Array.from(atob("ewogICJtb2R1bGUiOiAiL1VzZXJzL2Rpcmllbi9Ub29scy9yZXBvcy93b3Jrc2hvcHMvZGVzaWduaW5nLXJldXNhYmxlLWluZnJhc3RydWN0dXJlLWFzLWNvZGUvc29sdXRpb24vMDMtbW9kdWxlcy90Zi1tb2QtbWluZWNyYWZ0IiwKICAicGFja2FnZU5hbWUiOiAibW9kbWluZWNyYWZ0Igp9"), c => c.charCodeAt(0)));
