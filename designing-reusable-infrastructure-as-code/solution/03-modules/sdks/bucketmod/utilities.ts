...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("bucketmod");
			params.setVersion("4.6.0");
			params.setValue(Uint8Array.from(atob("ewogICJtb2R1bGUiOiAidGVycmFmb3JtLWF3cy1tb2R1bGVzL3MzLWJ1Y2tldC9hd3MiLAogICJ2ZXJzaW9uIjogIjQuNi4wIiwKICAicGFja2FnZU5hbWUiOiAiYnVja2V0bW9kIgp9"), c => c.charCodeAt(0)));
