...
export declare class Module extends pulumi.ComponentResource {
     ...
     */
    readonly s3_bucket_arn: pulumi.Output<string | undefined>;
    /**
     * The bucket domain name. Will be of format bucketname.s3.amazonaws.com.
     */
    readonly s3_bucket_bucket_domain_name: pulumi.Output<string | undefined>;
    /**
     ...
     */
    readonly s3_bucket_bucket_regional_domain_name: pulumi.Output<string | undefined>;
    /**
     * The Route 53 Hosted Zone ID for this bucket's region.
     */
    readonly s3_bucket_hosted_zone_id: pulumi.Output<string | undefined>;
    /**
     * The name of the bucket.
     */
    readonly s3_bucket_id: pulumi.Output<string | undefined>;
    /**
     * The lifecycle rules of the bucket, if the bucket is configured with lifecycle rules. If not, this will be an empty string.
     */
    readonly s3_bucket_lifecycle_configuration_rules: pulumi.Output<any | undefined>;
    /**
     * The policy of the bucket, if the bucket is configured with a policy. If not, this will be an empty string.
     */
    readonly s3_bucket_policy: pulumi.Output<string | undefined>;
    /**
     * The AWS region this bucket resides in.
     */
    readonly s3_bucket_region: pulumi.Output<string | undefined>;
    /**
     * The domain of the website endpoint, if the bucket is configured with a website. If not, this will be an empty string. This is used to create Route 53 alias records.
     */
    readonly s3_bucket_website_domain: pulumi.Output<string | undefined>;
    /**
     * The website endpoint, if the bucket is configured with a website. If not, this will be an empty string.
     */
    readonly s3_bucket_website_endpoint: pulumi.Output<string | undefined>;
    /**
     * ARN of the directory bucket.
     */
    readonly s3_directory_bucket_arn: pulumi.Output<string | undefined>;
    /**
     * Name of the directory bucket.
     */
    readonly s3_directory_bucket_name: pulumi.Output<string | undefined>;
    /**
