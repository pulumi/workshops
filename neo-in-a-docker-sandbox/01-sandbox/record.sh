...
#
# Do the whole DEMO.md flow inside the recording: banner, prompt, approvals,
# the guard, the landing. Stop with Ctrl-D / exit when Neo ends. Convert to a
...
note "the recording starts the sandbox via 01-sandbox/up.sh; end the Neo session to stop"
