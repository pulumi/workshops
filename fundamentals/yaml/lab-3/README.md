...
Now we need to create `Container` resources for the frontend and Mongo containers. Put this code for the Mongo container **just above the `backend-container` resource**:
...
Put this code for the `frontend-container` at the end of the file:
