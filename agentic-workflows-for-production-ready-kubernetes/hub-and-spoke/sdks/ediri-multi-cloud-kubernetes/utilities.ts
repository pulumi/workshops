...
export function resourceOptsDefaults(): any {
    return { version: getVersion(), pluginDownloadURL: "git://github.com/pulumi/workshops/agentic-workflows-for-production-ready-kubernetes/components/multi-cloud-kubernetes" };
}
