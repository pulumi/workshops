...
export class CronTab extends pulumi.CustomResource {
    ...
    public readonly spec!: pulumi.Output<outputs.stable.v1.CronTabSpec>;
    ...
    constructor(name: string, args?: CronTabArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        super(CronTab.__pulumiType, name, resourceInputs, opts);
    }
}
...
export interface CronTabArgs {
    ...
    spec?: pulumi.Input<inputs.stable.v1.CronTabSpec>;
}
