...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("gke");
			params.setVersion("44.0.0");
			params.setValue(Uint8Array.from(atob("ewogICJtb2R1bGUiOiAidGVycmFmb3JtLWdvb2dsZS1tb2R1bGVzL2t1YmVybmV0ZXMtZW5naW5lL2dvb2dsZS8vbW9kdWxlcy9wcml2YXRlLWNsdXN0ZXIiLAogICJ2ZXJzaW9uIjogIjQ0LjAuMCIsCiAgInBhY2thZ2VOYW1lIjogImdrZSIKfQ=="), c => c.charCodeAt(0)));
